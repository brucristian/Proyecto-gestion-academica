...
public class RegisterAcademicPeriodResponse {
    private final boolean successfully;
    private final String message;
    private final AcademicPeriodInfo academicPeriod;

    public RegisterAcademicPeriodResponse(boolean successfully, String message, AcademicPeriodInfo academicPeriod) {
